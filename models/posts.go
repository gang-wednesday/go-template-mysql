...
var (
	postAllColumns            = []string{"id", "title", "content", "author_id", "created_at", "updated_at", "deleted_at"}
	postColumnsWithoutDefault = []string{"title", "content", "author_id", "updated_at", "deleted_at"}
